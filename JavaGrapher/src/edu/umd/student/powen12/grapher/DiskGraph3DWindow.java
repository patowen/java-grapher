...
import static edu.umd.student.powen12.grapher.DiskGraph3D.ROT_RES;
import static edu.umd.student.powen12.grapher.DiskGraph3D.X_MAX;
import static edu.umd.student.powen12.grapher.DiskGraph3D.X_MIN;
import static edu.umd.student.powen12.grapher.DiskGraph3D.X_RES;
import static edu.umd.student.powen12.grapher.Graph3D.VIEW_DISTANCE;
import static edu.umd.student.powen12.grapher.Graph3D.X_CENTER;
import static edu.umd.student.powen12.grapher.Graph3D.Y_CENTER;
import static edu.umd.student.powen12.grapher.Graph3D.Z_CENTER;
...
/**
 * Represents the window for a disk/washer graph. The manual contains information regarding this graph type.
 * @author Patrick Owen
 */
public class DiskGraph3DWindow extends GraphWindow implements ActionListener
{
	...
	/**
	 * Initializes a DiskGraph3DWindow.
	 * @param owner the owner of the window.
	 */
	public DiskGraph3DWindow(Window owner)
	{
		super(owner, "Disk/Washer Graph");
